...
module.exports = async (deployer, network, accounts) => {
    ...
    if (network === "polygon" ) {
        ...
        pairToken = await MockToken.at(TAMG_TOKEN)
        ...
        // first mint
        await baseToken.transfer(pair.address, toUSDC(1000) ,  { from: admin, chainId: 137 }) // 1000 USDC
        await pairToken.transfer(pair.address, toEther(2000),  { from: admin, chainId: 137 } ) // 2000 TAMG
        await pair.mint(admin,  { from: admin, chainId: 137 } )

        await fs.writeFileSync(
            "../deployments/polygon-quickswap-USDC-TAMG-contracts.txt",
            `
