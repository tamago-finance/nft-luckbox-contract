  ...
  ERC1155Holder
{
  ...
  /// @notice finalize project for get seed
  /// @param _projectId ID of the event
  function finalizeProject(uint256 _projectId) public nonReentrant {
    require(projects[_projectId].active == true, "Given ID is invalid");
    require(
      IERC20(LINK_TOKEN).balanceOf(address(this)) >= FEE,
      "Insufficient LINK to proceed VRF"
    ...
    override
  {
    ...
    if (projectId != 0) {
      projects[projectId].seed = _randomness;
    }
  }
}
